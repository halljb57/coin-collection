...
@UIScoped
public class CreateTabPanel extends ViewComponent
{
    @Inject
    ...
    public void init()
    {
        ...
        l1.addComponent(new Label("Create Tab Panel"));
...
//        l2.addComponent(moreDetailForms.get());
        ...
        l4.setMargin(true);
        buyAndSellForms.get().init();
        l4.addComponent(buyAndSellForms.get());
...
//        tabSheet.setWidth("400px");
        ...
        verticalLayout.addComponent(toolbars.get());
    }
}
